  ...
  return (
    ...
    >
      <svg
        ...
        fill="none"
        className={cn(
          "pointer-events-none absolute h-3 w-2.5 text-fg-white opacity-0 transition-all",
          size === "md" && "size-3.5",
      ...
      <svg
        ...
        fill="none"
        className={cn(
          "pointer-events-none absolute size-3 text-fg-white opacity-0 transition-all",
          size === "md" && "size-3.5",
        ...
        <>
          ...
          {(label || hint) && (
            <div className={cn("inline-flex flex-col", sizes[size].textWrapper)}>
              {label && <p className={cn("text-secondary select-none", sizes[size].label)}>{label}</p>}
              {hint && (
                <span className={cn("text-tertiary", sizes[size].hint)} onClick={(e) => e.stopPropagation()}>
                  {hint}
                </span>
              )}
            </div>
